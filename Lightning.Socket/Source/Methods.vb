Namespace Lightning
    Public Partial Class Socket : Implements IDisposable
        ...
        Public Function Read(ByRef Buffer As Byte(), Offset As Int32, Length As Int32, Flags As Net.Sockets.SocketFlags, ByRef Result As Net.Sockets.SocketError) As Int32
            SyncLock ReadLock
                Dim TotalRead, InstanceRead As Int32 : Do
                    If NetSocket.Poll(1, Net.Sockets.SelectMode.SelectRead) = True
        ...
        Private Sub Listener(ListeningSocket As Net.Sockets.Socket)
            Dim ListenerGovernor As new Governor(10)
            Do While IsListening = True
                If IsConnected = True AndAlso ListeningSocket.Poll(1, Net.Sockets.SelectMode.SelectRead) = True Then
